...
{
    public partial class s18734Context : DbContext
    {
        public s18734Context()
        {
        }

        public s18734Context(DbContextOptions<s18734Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s18734;Integrated Security=True");
            }
        }
